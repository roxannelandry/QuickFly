...
public class LightFlightTest {
  ...
  private LightFlight lightFlight;

  @Before
  public void setUp() {
    lightFlight = new LightFlight(FLIGHT_SOURCE, FLIGHT_DESTINATION, FLIGHT_DATE, FLIGHT_COMPANY, NUMBER_OF_ECONOMIC_SEATS, ECONOMIC_SEATS_PRICE,
        NUMBER_OF_REGULAR_SEATS, REGULAR_SEATS_PRICE, NUMBER_OF_BUSINESS_SEATS, BUSINESS_SEATS_PRICE, IS_NOT_AIR_VIVANT);
  }

  @Test
  public void lightFlightThatHasExceedingWeightAvailable_seeingIfHasEnoughAvailableWeight_returnFalse() {
    assertFalse(lightFlight.hasEnoughExceedingWeightAvailable(VALID_WEIGHT));
  }

  @Test
  public void luggageThatExceedWeightAndFlightWithNotEnoughSpace_seeingIfIsExceedingWeightAllowed_returnTrue() {
    assertTrue(lightFlight.weightIsExceeding(INVALID_WEIGHT));
  }

  @Test
  public void luggageThatExceedWeightAndFlightWithExceedingWeighSpace_seeingIfIsExceedingWeightAllowed_returnFalse() {
    assertFalse(lightFlight.weightIsExceeding(VALID_WEIGHT));
  }

  @Test(expected = InvalidWeightException.class)
  public void validWeight_adjustingMaximumExceedingWeight_throwInvalidWeight() {
    lightFlight.adjustMaximumExceedingWeight(VALID_WEIGHT);
  }
  ...
  public void invalidNumberOfTickets_adjustingQuantityOfAvailableSeat_throwNotEnoughAvailableSeatsException() {
    lightFlight.adjustQuantityOfAvailableSeat(SEAT_CATEGORY, INVALID_NUMBER_OF_TICKETS);
  }

  @Test
  public void validNumberOfTickets_adjustingQuantityOfAvailableSeat_numberOfSeatsIsAdjusted() {
    lightFlight.adjustQuantityOfAvailableSeat(SEAT_CATEGORY, VALID_NUMBER_OF_TICKETS);

    assertEquals(lightFlight.getNumberOfSeatsAvailable(SEAT_CATEGORY), FLIGHT_SEATS_AVAILABLE - VALID_NUMBER_OF_TICKETS);
  }

  @Test
  public void flightInfosThatMatch_verifyingFlightIsMatchingInfo_returnTrue() {
    assertTrue(lightFlight.areInformationsMatching(FLIGHT_DATE_AS_DATETIME, FLIGHT_DESTINATION, FLIGHT_SOURCE));
  }

  @Test
  public void dateHigherThanFlightDate_verifyingFlightIsMatchingInfo_returnFalse() {
    assertFalse(lightFlight.areInformationsMatching(DATE_HIGHER_THAN_FLIGHT_DATE_AS_DATETIME, FLIGHT_DESTINATION, FLIGHT_SOURCE));
  }

  @Test
  public void invalidDestinationFlightInfos_verifyingFlightIsMatchingInfo_returnFalse() {
    assertFalse(lightFlight.areInformationsMatching(FLIGHT_DATE_AS_DATETIME, INVALID_FLIGHT_DESTINATION, FLIGHT_SOURCE));
  }

  @Test
  public void invalidSourceFlightInfos_verifyingFlightIsMatchingInfo_returnFalse() {
    assertFalse(lightFlight.areInformationsMatching(FLIGHT_DATE_AS_DATETIME, FLIGHT_DESTINATION, INVALID_FLIGHT_SOURCE));
  }

  @Test
  public void numberOfTicketsLessThanSeatAvailable_checkingIfhasEnoughAvailableSeat_returnTrue() {
    assertTrue(lightFlight.hasAvailableSeatsForThisCategory(SEAT_CATEGORY, VALID_NUMBER_OF_TICKETS));
  }

  @Test
  public void numberOfTicketsMoreThanSeatAvailable_checkingIfhasEnoughAvailableSeat_returnFalse() {
    assertFalse(lightFlight.hasAvailableSeatsForThisCategory(SEAT_CATEGORY, INVALID_NUMBER_OF_TICKETS));
  }

  @Test
  public void someSeatsAvailable_checkingIfHasSeatsAvailable_returnTrue() {
    assertTrue(lightFlight.hasAvailableSeats(true, true, true));
  }

  @Test
  public void noSeatsAvailable_checkingIfHasSeatsAvailable_returnFalse() {
    lightFlight.adjustQuantityOfAvailableSeat(SEAT_CATEGORY, FLIGHT_SEATS_AVAILABLE);

    assertFalse(lightFlight.hasAvailableSeats(false, true, false));
  }

  @Test
  public void luggageWeightAndNumberOfTicketsLessThanExceedingWeight_checkingIfHasValidWeight_returnTrue() {
    assertTrue(lightFlight.hasValidWeight(VALID_WEIGHT, ONE_TICKET));
  }

  @Test
  public void luggageWeightAndNumberOfTicketsMoreThanExceedingWeight_checkingIfHasValidWeight_returnFalse() {
    assertFalse(lightFlight.hasValidWeight(INVALID_WEIGHT, ONE_TICKET));
  }

  @Test
  public void weightLowerThanMaximumWeight_gettingExtraFeesByWeight_returnZeroExtraFees() {
    assertEquals(lightFlight.getExtraFeesForExceedingWeight(VALID_WEIGHT), NO_EXTRA_FEES, 0);
  }
  ...
  public void flight_convertingFlightToString_returnStringFormattedWithFlightInfos() {
    ...
    passengerFlightInString += "Source : " + FLIGHT_SOURCE + separator + "Destination : " + FLIGHT_DESTINATION + separator + "Date : "
        + FLIGHT_DATE_ONLY + separator + "Departure time : " + FLIGHT_TIME + separator + "Company : " + FLIGHT_COMPANY + separator + "AirVivant : "
        + NOT_AIR_VIVANT + separator;
    passengerFlightInString += "Weight Category : " + WeightCategory.AIR_LEGER + separator;

    assertEquals(lightFlight.flightToString(), passengerFlightInString);
  }
